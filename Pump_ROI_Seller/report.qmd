...
Uue **`r params$product`** pumpade süsteemi rakendamine **`r params$project`** jaoks näitab erakordset finantstulemuslikkust võrreldes praeguse pumba infrastruktuuriga. **`r params$product`** pakub veenvaid majanduslikke eeliseid. Kogusääst **`r params$years`** aastate jooksul on **€`r params$total_savings`**. See tähendab tugevat **`r params$roi_percent`%** investeeringu tasuvust. Esialgne investeering tasutakse tagasi **`r params$payback_years`** aastaga. The annual CO2 reduction will be **`r format(calc$annual_co2_savings, big.mark = ",")`** kg.



# Peamised järeldused{.unnumbered}
...
<span style="font-size: 1.2em; color: #B2B2B2; margin-top: 0.5em; display: block; font-weight: bold;"> pumba tõhususe erinevused.</span>
:::
::: {.key-value-box style="background-color: #f9f9f9; padding: 15px; border-radius: 5px;"}
<div style="font-size: 2.5em; color: #3EB0E6; font-weight: bold;">`r params$energy_savings`</div>
<span style="font-size: 1.2em; color: #B2B2B2; margin-top: 0.5em; display: block; font-weight: bold;"> aastaste energiakulude säästmiseks.</span>
:::
::: {.key-value-box style="background-color: #f9f9f9; padding: 15px; border-radius: 5px;"}
<div style="font-size: 2.5em; color: #3EB0E6; font-weight: bold;">`r params$mtbf_improvement`</div>
<span style="font-size: 1.2em; color: #B2B2B2; margin-top: 0.5em; display: block; font-weight: bold;"> erinevuste puhul MTBF.</span>
:::

::: {.key-value-box style="background-color: #f9f9f9; padding: 15px; border-radius: 5px;"}
<div style="font-size: 2.5em; color: #3EB0E6; font-weight: bold;">`r params$downtime_savings`</div>
<span style="font-size: 1.2em; color: #B2B2B2; margin-top: 0.5em; display: block; font-weight: bold;"> aastased seisakute erinevused.</span>
:::

::: {.key-value-box style="background-color: #f9f9f9; padding: 15px; border-radius: 5px;"}
<div style="font-size: 2.5em; color: #3EB0E6; font-weight: bold;">`r params$maintenance_savings`</div>
<span style="font-size: 1em; color: #B2B2B2; margin-top: 0.5em; display: block; font-weight: bold;"> hoolduskulude kokkuhoidmiseks.</span>
:::
::: {.key-value-box style="background-color: #f9f9f9; padding: 15px; border-radius: 5px;"}
<div style="font-size: 2.5em; color: #3EB0E6; font-weight: bold;">`r params$warranty`</div>
<span style="font-size: 1.2em; color: #B2B2B2; margin-top: 0.5em; display: block; font-weight: bold;"> Garantiiperioodi erinevuste puhul.</span>
:::
